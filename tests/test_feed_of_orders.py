...
class TestFeedOfOrders:
    ...
    def test_click_on_order_open_popup_window_with_details(self, driver):
        feed_of_orders_page = FeedOfOrdersPage(driver)
    ...
    def test_users_orders_displayed_in_order_history_and_on_order_feed_pages(self, driver, registered_user_data):
    ...
    def test_counter_increases_after_created_new_order(self, driver, registered_user_data, counter_locator, counter_name):
        email, password = registered_user_data
        login_page = LoginPage(driver)
        login_page.open_login_page()
        login_page.fill_authorize_form_and_click_enter(email, password)
    ...
    def test_after_placing_order_its_number_appears_in_progress_section(self, driver, registered_user_data):
        email, password = registered_user_data
        login_page = LoginPage(driver)
        login_page.open_login_page()
        login_page.fill_authorize_form_and_click_enter(email, password)
